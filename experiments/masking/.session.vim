...
silent only
cd ~/Desktop/unik4690/Machinevision---Self-driving-car/lane_detection
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +3 main.cpp
badd +0 debug_stuff.cpp
badd +1 .
badd +0 debug_stuff.hpp
badd +0 M
badd +0 build/Makefile
