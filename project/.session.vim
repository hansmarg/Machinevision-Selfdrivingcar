...
badd +0 main.cpp
badd +3 debug_stuff.cpp
badd +0 debug_stuff.hpp
badd +0 ../lane_detection/includes/debug_stuff.cpp
badd +0 includes/homo_trans.hpp
badd +0 includes/homo_trans.cpp
badd +0 ~/.vimrc
badd +0 includes/video_loader.cpp
badd +0 includes/video_loader.hpp
badd +0 ~/Desktop/unik4690/Machinevision---Self-driving-car/experiments/homo_transform/main.cpp
badd +0 includes/shapes.cpp
badd +28 includes/shapes.hpp
badd +0 ~/Desktop/unik4690/Machinevision---Self-driving-car/experiments/masking/main.cpp
badd +13 includes/histogram.hpp
badd +0 includes/histogram.cpp
badd +0 ~/Desktop/unik4690/Machinevision---Self-driving-car/experiments/histogram/main.cpp
badd +0 includes/debug_stuff.hpp
badd +1 ~/Desktop/unik4690/Machinevision---Self-driving-car/lane_detection/lane.cpp
badd +0 histogram.cpp
badd +1 .
argglobal
silent! argdel *
...
let s:l = 31 - ((29 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
normal! 017|
tabedit histogram.cpp
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
...
setlocal nowrap
setlocal wrapmargin=0
tabedit ~/Desktop/unik4690/Machinevision---Self-driving-car/lane_detection/lane.cpp
set splitbelow splitright
wincmd t
set winheight=1 winwidth=1
argglobal
...
11
normal! 0
tabedit includes/debug_stuff.hpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ../lane_detection/includes/debug_stuff.cpp
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
exe 'vert 1resize ' . ((&columns * 74 + 75) / 150)
exe 'vert 2resize ' . ((&columns * 75 + 75) / 150)
tabedit includes/histogram.hpp
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
56
normal! zo
let s:l = 65 - ((30 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
